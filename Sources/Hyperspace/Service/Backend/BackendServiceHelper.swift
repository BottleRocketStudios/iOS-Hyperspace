...
public struct BackendServiceHelper {
    ...
    public static func handleResponseData<T: Request>(_ data: Data, serviceSuccess: NetworkServiceSuccess, for request: T, completion: @escaping BackendServiceCompletion<T.ResponseType, T.ErrorType>) {
        let transformResult = request.transformData(data, serviceSuccess: serviceSuccess)
